        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              <span className="text-xs bg-green-50 text-green-700 px-2 py-1 rounded-full">🌱 Organic</span>
              <span className="text-xs bg-green-50 text-green-700 px-2 py-1 rounded-full">🚫 No Seed Oils</span>
              <span className="text-xs bg-green-50 text-green-700 px-2 py-1 rounded-full">💚 Clean Labels</span>
            </div>
          </div>
